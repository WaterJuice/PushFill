...
class _BaseClass:
    ...
    # ────────────────────────────────────────────────────────────────────────────────────
    def __init__(self, *, items: Optional[list[ArgsItem]] = None):
    ...
    def add_argument(
        ...
        *name_or_flags: str,
        ...
        const: Any = ...,
        default: Any = ...,
        type: Union[Callable[[str], _T], Callable[[str], _T]] = ...,
        choices: Iterable[_T] = ...,
        required: bool = ...,
        help: Optional[str] = ...,
    ...
    # ────────────────────────────────────────────────────────────────────────────────────
    def add_group(
        self, name: str, *, items: Optional[list[ArgsItem]] = None
    ) -> "ArgsGroup":
        """
    ...
    # ────────────────────────────────────────────────────────────────────────────────────
    def add_mutex_group(
        self, *, required: bool = False, items: Optional[list[ArgsItem]] = None
    ) -> "ArgsMutexGroup":
        """
...
class ArgsParser(_BaseClass):
    ...
    Attributes:
        prog (Optional[str]): Can be set after initialisation, before parse().
        description (Optional[str]): Can be set after initialisation, before parse().
        version (Optional[str]): Can be set after initialisation, before parse().
        default_command (Optional[str]): Can be set after initialisation, before parse().
    ...
    def __init__(
        ...
        self.__common_collection__: Optional[ArgsCollection] = None
    ...
    def add_command(
        ...
        name: str,
        *,
        items: Optional[list[ArgsItem]] = None,
    ...
    def create_common_collection(
        self, *, items: Optional[list[ArgsItem]] = None, options_first: bool = False
    ) -> "ArgsCollection":
        """
    ...
    def parse(self, argv: Optional[list[str]] = None) -> Namespace:
        ...
        command_groups: dict[str, list[tuple[str, Optional[str]]]] = {}
        group_descriptions: dict[str, Optional[str]] = {}
    ...
    # ────────────────────────────────────────────────────────────────────────────────────
    @classmethod
    def new_collection(cls, items: Optional[list[ArgsItem]] = None) -> "ArgsCollection":
        """
    ...
    @classmethod
    def new_group(
        cls, name: str, *, items: Optional[list[ArgsItem]] = None
    ) -> "ArgsGroup":
        """
    ...
    @classmethod
    def new_mutex_group(
        cls, *, required: bool = False, items: Optional[list[ArgsItem]] = None
    ) -> "ArgsMutexGroup":
        """
...
class ArgsCommand(_BaseClass):
    ...
    def __init__(
        ...
        *,
        ...
        self._common_collection: Optional[ArgsCollection] = None
        if items:
            self.add(*items)
...
class ArgsCommandGroup:
    ...
    def __init__(
        ...
        *,
        description: Optional[str] = None,
        parent: Optional["ArgsParser"] = None,
    ):
...
class ArgsGroup(_BaseClass):
    ...
    # ────────────────────────────────────────────────────────────────────────────────────
    def __init__(self, name: str, *, items: Optional[list[ArgsItem]] = None):
        super().__init__()
        self.__group_name = name
        if items:
            self.add(*items)
...
class _FixedHelpFormatter(argparse.HelpFormatter):
    ...
    def _fill_text(self, text: str, width: int, indent: str) -> str:  # noqa: ARG002
        """Fill text while preserving explicit line breaks and indentation.

        Uses raw text formatting to preserve the exact layout of description
        and epilog text.
        """
        _ = width  # Unused; we preserve raw formatting instead of wrapping
...
class _GroupedCommandsHelpFormatter(_FixedHelpFormatter):
    ...
    def __init__(
        ...
        command_groups: Optional[dict[str, list[tuple[str, Optional[str]]]]] = None,
        group_descriptions: Optional[dict[str, Optional[str]]] = None,
        **kwargs: Any,
    ):
    ...
    def _format_grouped_subparsers(
        ...
        subparsers: dict[str, Optional[str]] = {}
        ...
        def format_command(
            name: str, help_text: Optional[str], *, coloured_name: str
        ) -> str:
